...
def get_flight_one_way(from_id,to_id,start_date,adults,children,infants,retries=3, delay=2):
...
def get_flight_two_way(from_id,to_id,start_date,return_date,adults,children,infants,retries=3, delay=2):
